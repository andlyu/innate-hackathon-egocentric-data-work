...
> **Note:** There is a known coordinate misalignment in the visualization between the robot and human data. The pipeline adjusts for this correctly, but please verify before running.
